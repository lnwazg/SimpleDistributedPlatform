    ...
    public void paint(Graphics g)
    {
        ...
        if (bgColor != null)
        {
            ...
            if (orient == JSplitPane.HORIZONTAL_SPLIT)
            {
                ...
                Stroke sroke = new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, new float[] {2, 2}, 0);//实线，空白
                ...
                __Icon9Factory__.getInstance()
                    .getSplitTouchBg1()
                    .draw((Graphics2D)g, diverTouchStartX, halfHeight - decratedButton_h / 2, decratedButton_w, decratedButton_h);
            }
            else
            {
                int halfHeight = size.height / 2;
                ...
                __Icon9Factory__.getInstance()
                    .getSplitTouchBg1()
                    .draw((Graphics2D)g, halfWidth - decratedButton_h, diverTouchStartY, decratedButton_h, decratedButton_w);
            }
            //			g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,
