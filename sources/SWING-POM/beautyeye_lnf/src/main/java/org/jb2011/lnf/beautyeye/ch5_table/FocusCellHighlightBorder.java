...
class FocusCellHighlightBorder extends AbstractBorder
{
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height)
    {
        ...
        //* @since 3.5
        BEUtils.draw4RecCorner(g, x, y, width - 2, height - 2, 5, UIManager.getColor("Table.focusCellHighlightBorderColor"));
        BEUtils.draw4RecCorner(g, x + 1, y + 1, width - 2, height - 2, 5, UIManager.getColor("Table.focusCellHighlightBorderHighlightColor"));
    }
}