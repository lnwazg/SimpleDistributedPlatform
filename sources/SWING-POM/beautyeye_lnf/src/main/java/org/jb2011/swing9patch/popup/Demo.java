...
public class Demo extends JPanel
{
    ...
    private void initGUI()
    {
        ...
        btnShow.setToolTipText("<html>\n" + "<body>\n" + "This message just used for demo, cool tool tip!\n" + "<br>\n" + "Ni hao Jack Jiang.\n" + "</body>\n"
            + "</html>\n");
        
        // init btn pane
        JPanel btnPane =
            NPComponentUtils.createPanel_root(NPHelper.createNinePatch(Launch.class.getResource("imgs/np/cool_tool_tip_demo_bg.9.png"), false), new Insets(150,
                50, 50, 50));
