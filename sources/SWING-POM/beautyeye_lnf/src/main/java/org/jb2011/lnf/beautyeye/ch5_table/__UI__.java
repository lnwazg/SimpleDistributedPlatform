...
public class __UI__
{
    ...
    public static void uiImpl()
    {
        ...
        UIManager.put("Table.focusCellHighlightBorderHighlightColor", new ColorUIResource(new Color(255, 255, 255, 70)));//注意：这个颜色是半透明的哦
    ...
    public static class TableHeaderBorder extends javax.swing.border.AbstractBorder
    {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h)
        {
            ...
            //绘制表头单元的右分隔竖线
            org.jb2011.lnf.beautyeye.ch5_table.__Icon9Factory__.getInstance().getTableHeaderCellSeparator1().draw((Graphics2D)g, w - 4, 0, 4, h);
