...
public class WinUtils
{
    ...
    public static void paintText(Graphics g, AbstractButton b, Rectangle textRect, String text, int textShiftOffset)
    {
        ...
        FontMetrics fm = MySwingUtilities2.getFontMetrics(b, g);//* modified by Jack Jiang 为了非公开api的兼容性
    ...
    static void paintClassicText(AbstractButton b, Graphics g, int x, int y, String text, int mnemIndex)
    {
        ...
        if (model.isEnabled())
        {
            ...
            MySwingUtilities2.drawStringUnderlineCharAt(b, g, text, mnemIndex, x, y);//* modified by Jack Jiang 为了非公开api的兼容性
        }
        else
        {
            ...
            else
            {
                ...
                //						x + 1, y + 1);
                MySwingUtilities2.drawStringUnderlineCharAt(b, g, text, mnemIndex, x + 1, y + 1);//* modified by Jack Jiang 为了非公开api的兼容性
            }
            if (color == null)
            {
