...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 一些说明 END
public class BEComboBoxUI extends BasicComboBoxUI implements org.jb2011.lnf.beautyeye.BeautyEyeLNFHelper.__UseParentPaintSurported
{
    /**
     * Creates the ui.
     *
    ...
    {
        return comboBox != null && (!(comboBox.getBorder() instanceof UIResource) || !(comboBox.getBackground() instanceof UIResource));
    }
    ...
    protected JButton createArrowButton()
    {
        JButton button = new JButton()
        {
            ...
            public void paint(Graphics g)
            {
                ...
                {
                    if (isPressed)
                        __Icon9Factory__.getInstance().getButtonArrow_pressed().draw((Graphics2D)g, 0, 0, this.getWidth(), this.getHeight());
                    else
                        __Icon9Factory__.getInstance().getButtonArrow_normal().draw((Graphics2D)g, 0, 0, this.getWidth(), this.getHeight());
                }
                else
                {
                    __Icon9Factory__.getInstance().getButtonArrow_disable().draw((Graphics2D)g, 0, 0, this.getWidth(), this.getHeight());
                }
            }
    ...
    public void paintCurrentValueBackground(Graphics g, Rectangle bounds, boolean hasFocus)
    {
        ...
        if (!isUseParentPaint())
        {
            if (comboBox.isEnabled())
                org.jb2011.lnf.beautyeye.ch6_textcoms.__Icon9Factory__.getInstance()
                    .getTextFieldBgNormal()
                    .draw((Graphics2D)g, 0, 0, comboBox.getWidth(), comboBox.getHeight());
            else
                org.jb2011.lnf.beautyeye.ch6_textcoms.__Icon9Factory__.getInstance()
                    .getTextFieldBgDisabled()
                    .draw((Graphics2D)g, 0, 0, comboBox.getWidth(), comboBox.getHeight());
        }
        else
        {
