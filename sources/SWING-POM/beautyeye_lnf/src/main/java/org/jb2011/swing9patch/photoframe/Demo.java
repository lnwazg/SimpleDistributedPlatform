...
public class Demo extends JPanel
{
    ...
    private void initGUI()
    {
        ...
        panePhotoframe.add(new JLabel(new ImageIcon(org.jb2011.swing9patch.photoframe.Demo.class.getResource("imgs/girl.png"))), BorderLayout.CENTER);
    ...
    public void showNewFrame()
    {
        ...
        dialogForShowingPhoto.setSize(Integer.parseInt(txtPhotoframeDialogWidth.getText().trim()), Integer.parseInt(txtPhotoframeDialogHeight.getText().trim()));
    ...
    class AABorder extends NinePatchBorder//AbstractBorder
    {
        ...
        public AABorder()
        {
            super(new Insets(TOP, LEFT, BOTTOM, RIGHT), NPHelper.createNinePatch(Launch.class.getResource("imgs/np/225.9.png"), false));
        }
    }
}
