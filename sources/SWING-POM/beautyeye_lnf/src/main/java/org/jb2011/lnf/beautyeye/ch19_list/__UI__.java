...
public class __UI__
{
    ...
    public static void uiImpl()
    {
        ...
        UIManager.put("List.focusSelectedCellHighlightBorderHighlightColor", new ColorUIResource(new Color(255, 255, 255, 70)));//注意：这个颜色是半透明的哦
        //列表单元获得焦点时的边框（windows主题下是一个距形虚线框）——之前老也想不通的与左边隔一个像素的白边问题就是没设置它造成的
        UIManager.put("List.focusSelectedCellHighlightBorder", new BorderUIResource(
            new org.jb2011.lnf.beautyeye.ch19_list.__UI__.FocusSelectedCellHighlightBorder()));
