        ...
        try
        {
            ...
            if (JVM.current().isOrLater(JVM.JDK1_7))
            {
                ...
                isTranslucencySupported =
                    ((Boolean)(ReflectHelper.invokeMethod(GraphicsDevice.class,
                        gd,
            ...
            else if (JVM.current().isOrLater(JVM.JDK1_6))
            {
                ...
                isTranslucencySupported =
                    ((Boolean)(ReflectHelper.invokeMethod(Class.forName("com.sun.awt.AWTUtilities"),
                        _WindowTranslucency,
                        "isTranslucencySupported",
                        new Class[] {_WindowTranslucency},
                        new Object[] {Enum.valueOf(_WindowTranslucency, "TRANSLUCENT")}))).booleanValue();
    ...
    public static void setOpacity(Window w, float opacity)
    {
        ...
        try
        {
            ...
            if (JVM.current().isOneDotSixUpdate12OrAfter())//JDK1_6_U10//为什么要到u12才支持？因u10里的窗口透明存在BUG 6750920
            {
                ...
                //1.7.0及以后版本
                if (JVM.current().isOrLater(JVM.JDK1_7))
                    ReflectHelper.invokeMethod(Window.class, w, "setOpacity", new Class[] {float.class}, new Object[] {opacity});
                else
                    ReflectHelper.invokeStaticMethod("com.sun.awt.AWTUtilities", "setWindowOpacity", new Class[] {Window.class, float.class}, new Object[] {w,
                        opacity});
            }
            else
        ...
        try
        {
            ...
            if (JVM.current().isOneDotSixUpdate12OrAfter())//JDK1_6_U10//为什么要到u12才支持？因u10里的窗口透明存在BUG 6750920
            {
                ...
                if (JVM.current().isOrLater(JVM.JDK1_7))
                {
                    ...
                    ReflectHelper.invokeStaticMethod("com.sun.awt.AWTUtilities", "setWindowOpaque", new Class[] {Window.class, boolean.class}, new Object[] {w,
                        opaque});
            }
            else
