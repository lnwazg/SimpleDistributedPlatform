...
public class BEComboBoxRenderer extends BasicComboBoxRenderer
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        {
            org.jb2011.lnf.beautyeye.ch9_menu.__Icon9Factory__.getInstance()
        ...
        else
        {
            ...
            if (!ui.isPopupVisible(null) && ui.getCombox().isFocusOwner()//没有此行，则意味着它在禁用等状态时任然会如此绘制（实际是不需要绘制）
            )
            {
                ...
                BEUtils.fillTextureRoundRec((Graphics2D)g, this.getBackground(), is.left, is.top, this.getWidth() - is.left - is.right, this.getHeight()
                    - is.top - is.bottom, 20, 20);//20,20
            }
        }
