...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 一些说明 END
public class BEProgressBarUI extends BasicProgressBarUI implements org.jb2011.lnf.beautyeye.BeautyEyeLNFHelper.__UseParentPaintSurported
{
    ...
    {
        return progressBar != null && (!(progressBar.getForeground() instanceof UIResource) || !(progressBar.getBackground() instanceof UIResource));
    }
     ...
     */
    protected void paintProgressBarContentImpl(boolean isHorizontal, Graphics g, int x, int y, int amountFull, int barContentRectHeight,
    ...
    private void paintString(Graphics g, int x, int y, int width, int height, int fillStart, int amountFull, Insets b)
    {
        ...
        ReflectHelper.invokeMethod(BasicProgressBarUI.class, this, "paintString", new Class[] {Graphics.class, int.class, int.class, int.class, int.class,
            int.class, int.class, Insets.class}, new Object[] {g, x, y, width, height, fillStart, amountFull, b});
    }
}
