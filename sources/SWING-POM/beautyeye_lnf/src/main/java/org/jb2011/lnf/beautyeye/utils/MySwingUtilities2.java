...
public class MySwingUtilities2
{
    ...
    public static FontMetrics getFontMetrics(JComponent c, Graphics g)
    {
        ...
        return (FontMetrics)invokeSwingUtilities2StaticMethod("getFontMetrics", new Class[] {JComponent.class, Graphics.class}, new Object[] {c, g});
    }
    ...
    public static FontMetrics getFontMetrics(JComponent c, Graphics g, Font font)
    {
        ...
        return (FontMetrics)invokeSwingUtilities2StaticMethod("getFontMetrics", new Class[] {JComponent.class, Graphics.class, Font.class}, new Object[] {c, g,
            font});
    }
    ...
    public static int stringWidth(JComponent c, FontMetrics fm, String string)
    {
        ...
        return (Integer)invokeSwingUtilities2StaticMethod("stringWidth", new Class[] {JComponent.class, FontMetrics.class, String.class}, new Object[] {c, fm,
            string});
    }
    ...
    {
        invokeSwingUtilities2StaticMethod("drawString", new Class[] {JComponent.class, Graphics.class, String.class, int.class, int.class}, new Object[] {c, g,
            text, x, y});
    ...
    static boolean isPrinting(Graphics g)
    {
        ...
        return (Boolean)invokeSwingUtilities2StaticMethod("isPrinting", new Class[] {Graphics.class}, new Object[] {g});
    }
    ...
    private static boolean drawTextAntialiased(JComponent c)
    {
        ...
        //        return AA_TEXT;
        return (Boolean)invokeSwingUtilities2StaticMethod("drawTextAntialiased", new Class[] {JComponent.class}, new Object[] {c});
    }
    ...
    public static boolean drawTextAntialiased(boolean aaText)
    {
        ...
        //        // 'swing.aatext' was defined, use its value.
        //        return AA_TEXT;
        return (Boolean)invokeSwingUtilities2StaticMethod("drawTextAntialiased", new Class[] {boolean.class}, new Object[] {aaText});
    }
    ...
    public static Graphics2D getGraphics2D(Graphics g)
    {
        ...
        //            return null;
        //        }
        return (Graphics2D)invokeSwingUtilities2StaticMethod("getGraphics2D", new Class[] {Graphics.class}, new Object[] {g});
    }
    ...
    public static void drawStringUnderlineCharAt(JComponent c, Graphics g, String text, int underlinedIndex, int x, int y)
    {
        ...
        //        }
        invokeSwingUtilities2StaticMethod("drawStringUnderlineCharAt", new Class[] {JComponent.class, Graphics.class, String.class, int.class, int.class,
            int.class}, new Object[] {c, g, text, underlinedIndex, x, y});
    }
    ...
    public static String clipStringIfNecessary(JComponent c, FontMetrics fm, String string, int availTextWidth)
    {
        ...
        //       }
        string =
            (String)invokeSwingUtilities2StaticMethod("clipStringIfNecessary",
    ...
    {
        string =
            (String)invokeSwingUtilities2StaticMethod("clipString", new Class[] {JComponent.class, FontMetrics.class, String.class, int.class}, new Object[] {
                c, fm, string, availTextWidth});
    ...
    {
        return ReflectHelper.invokeStaticMethod(ReflectHelper.getClass(getSwingUtilities2ClassName()), methodName, paramsType, paramsValue);
    }
