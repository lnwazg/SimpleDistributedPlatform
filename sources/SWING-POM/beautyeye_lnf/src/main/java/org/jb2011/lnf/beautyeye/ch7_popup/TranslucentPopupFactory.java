    ...
    protected class TranslucentPopup extends Popup
    {
        ...
        protected void reset(Component owner, Component contents, int ownerX, int ownerY)
        {
            ...
            if (c instanceof JWindow)
            {
                ...
                WindowTranslucencyHelper.setOpacity(component, isTooltip ? 1.0f : isComboBoxPopup ? 0.95f : 0.95f);//0.85f : 0.95f);//0.8f : 0.95f);
                ...
                //图片填充背景的内容面板
                ImageBgPanel imageContentPane = new ImageBgPanel().setN9(isTooltip ? __Icon9Factory__.getInstance().getTooltipBg() : isComboBoxPopup ? //是下拉框列表则使一个跟JScrollPane一样的背景图，好看！
                ...
                if (contents instanceof JComponent)
                {
                    ...
                    ((JComponent)contents).setBorder(isTooltip ? BorderFactory.createEmptyBorder(6, 8, 12, 12)//6,8,12,8)
