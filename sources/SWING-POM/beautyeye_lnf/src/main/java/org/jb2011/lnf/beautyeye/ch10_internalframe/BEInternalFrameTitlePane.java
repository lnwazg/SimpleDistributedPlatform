...
public class BEInternalFrameTitlePane extends BasicInternalFrameTitlePane
{
    ...
    class XMetalTitlePaneLayout extends TitlePaneLayout
    {
        ...
        public Dimension minimumLayoutSize(Container c)
        {
            ...
            int title_w = frameTitle != null ? MySwingUtilities2.stringWidth(frame, fm, frameTitle) : 0;
            int title_length = frameTitle != null ? frameTitle.length() : 0;
            
            if (title_length > 2)
            {
                int subtitle_w = MySwingUtilities2.stringWidth(frame, fm, frame.getTitle().substring(0, 2) + "...");
    ...
    {
        BETitlePane.paintTitlePane(g, frameInsets.left//0
            ,
            frameInsets.top//0
            ,
            width - frameInsets.left - frameInsets.right//-0
