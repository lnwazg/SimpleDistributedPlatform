...
public class BERootPaneUI extends BasicRootPaneUI
{
     ...
     */
    private static final String[] borderKeys = new String[] {null, "RootPane.frameBorder", "RootPane.plainDialogBorder", "RootPane.informationDialogBorder",
        "RootPane.errorDialogBorder", "RootPane.colorChooserDialogBorder", "RootPane.fileChooserDialogBorder", "RootPane.questionDialogBorder",
    ...
    private static class XMetalRootLayout implements LayoutManager2
    {
        ...
        public Dimension preferredLayoutSize(Container parent)
        {
            ...
            if (root.getWindowDecorationStyle() != JRootPane.NONE && (root.getUI() instanceof BERootPaneUI))
            {
                JComponent titlePane = ((BERootPaneUI)root.getUI()).getTitlePane();
                if (titlePane != null)
                {
     ...
     */
    private static final int[] cursorMapping = new int[] {Cursor.NW_RESIZE_CURSOR, Cursor.NW_RESIZE_CURSOR, Cursor.N_RESIZE_CURSOR, Cursor.NE_RESIZE_CURSOR,
        Cursor.NE_RESIZE_CURSOR, Cursor.NW_RESIZE_CURSOR, 0, 0, 0, Cursor.NE_RESIZE_CURSOR, Cursor.W_RESIZE_CURSOR, 0, 0, 0, Cursor.E_RESIZE_CURSOR,
        Cursor.SW_RESIZE_CURSOR, 0, 0, 0, Cursor.SE_RESIZE_CURSOR, Cursor.SW_RESIZE_CURSOR, Cursor.SW_RESIZE_CURSOR, Cursor.S_RESIZE_CURSOR,
    ...
    private class MouseInputHandler implements MouseInputListener
    {
        ...
        {
            Insets insets = w.getInsets();
            return getCursor_new(x - insets.left, y - insets.top, w.getWidth() - insets.left - insets.right, w.getHeight() - insets.top - insets.bottom);
        }
