...
public class N9ComponentFactory extends JLabel
{
    ...
    {
        return createLabel_root(txt, __Icon9Factory__.getInstance().getHintBgLightBlue(), new Insets(1, 6, 1, 6), Color.white, new Font("宋体", Font.BOLD, 12));
    }
    ...
    {
        return createLabel_root(txt, __Icon9Factory__.getInstance().getTipsBg(), new Insets(15, 3, 28, 3), new Color(139, 119, 75), null);
    }
    ...
    {
        return createLabel_root(txt, __Icon9Factory__.getInstance().getOrangeBaloon(), new Insets(4, 9, 9, 9)//3, 9, 8, 9)
            ,
    ...
    {
        return createLabel_root(txt, __Icon9Factory__.getInstance().getHintBgLightGray(), new Insets(2, 8, 2, 8), Color.white, new Font("宋体", Font.PLAIN, 12));
    }
