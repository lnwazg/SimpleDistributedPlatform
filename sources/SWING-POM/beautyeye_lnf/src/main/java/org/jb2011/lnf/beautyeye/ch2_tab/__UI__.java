...
public class __UI__
{
    ...
    public static void uiImpl()
    {
        ...
        UIManager.put("TabbedPane.tabAreaInsets", new javax.swing.plaf.InsetsUIResource(3, 20, 2, 20));//默认是3,2,2,2
        //此属性决定了tab与内容面板间的空白
        UIManager.put("TabbedPane.contentBorderInsets", new javax.swing.plaf.InsetsUIResource(2, 0, 3, 0));//默认是2,2,3,3
