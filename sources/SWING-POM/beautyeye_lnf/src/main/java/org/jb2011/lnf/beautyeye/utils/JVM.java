...
public class JVM
{
    ...
    {
        return jdkVersion == JDK1_6 || jdkVersion == JDK1_6_U10_AND_AFTER;//如果JDK是1.6_u10及以上那当然也是JDK1.6大版本了
    }
    ...
    public boolean isOneDotSixUpdate12OrAfter()
    {
        ...
        return (jdkVersion == JDK1_6_U10_AND_AFTER && !isJDK1_6_U10 && !isJDK1_6_U11) || jdkVersion >= JDK1_7;
    }
