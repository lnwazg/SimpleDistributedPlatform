...
public class BEToggleButtonUI extends BasicToggleButtonUI//WindowsToggleButtonUI//
{
    ...
    public static ComponentUI createUI(JComponent b)
    {
        ...
        BEToggleButtonUI windowsToggleButtonUI = (BEToggleButtonUI)appContext.get(WINDOWS_TOGGLE_BUTTON_UI_KEY);
    ...
    protected void paintText(Graphics g, JComponent c, Rectangle textRect, String text)
    {
        ...
        if (model.isEnabled())
        {
            ...
            MySwingUtilities2.drawStringUnderlineCharAt(c, g, text, mnemonicIndex, textRect.x + getTextShiftOffset(), textRect.y + fm.getAscent()
                + getTextShiftOffset());
        }
        else
        {
