...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 一些说明 END
public class BEToolBarUI extends BasicToolBarUI implements org.jb2011.lnf.beautyeye.BeautyEyeLNFHelper.__UseParentPaintSurported
{
    /**
     * Creates the ui.
     *
    ...
    {
        return toolBar != null && (!(toolBar.getBackground() instanceof UIResource));
    }
    ...
    public static class ToolBarBorder extends AbstractBorder implements UIResource, SwingConstants
    {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int width, int height)
        {
            ...
            if (((JToolBar)c).isFloatable())
            {
                ...
                Stroke sroke = new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, new float[] {1, 1}, 0);//实线，空白
