...
{
    private static final long serialVersionUID = -4489812584596568155L;
    ...
    protected void initForVista()
    {
        if (WinUtils.isOnVista())
        {
            ...
            UIManager.put("CheckBoxMenuItem.checkIcon", new org.jb2011.lnf.beautyeye.ch9_menu.BECheckBoxMenuItemUI.CheckBoxMenuItemIcon().setUsedForVista(true));//javax.swing.plaf.basic.BasicIconFactory.CheckBoxMenuItemIcon);
